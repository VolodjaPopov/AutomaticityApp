...
const INVALID_USER_CREDENTIALS = {
    ...
    MAIL_WITH_DOT_COM_IN_THE_MIDDLE: `${generateRandomString(5)}@test.com${generateRandomString(5)}@More`, 
    MAIL_WITH_EMPTY_SPACES_AFTER_FIRST_CHARACTERS: `${generateRandomString(3)}                   @test.com`, 
