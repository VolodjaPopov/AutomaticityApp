...
export class CustomersAPI {
  ...
  async delete({
    ...
    let response = await this.page.request.delete(
      `${customersEndpoint()}/${userID}`,
      {
        headers: {
          Accept: this.getAcceptHeader(),
  ...
  async getBillingInfo({
    ...
    let response = await this.page.request[method](
      `${customersEndpoint()}/${userID}/billing-info`,
      {
        headers: {
          Accept: this.getAcceptHeader(),
          Authorization: this.getAuthorizationHeader(token),
  ...
  async updateBillingInfo({
    ...
    if (response.status() == 200) {
      ...
      expect(responseJSON.billing_info.card_expiration_date).toBe(
      ...
      switch (response.status()) {
        ...
        case 422:
          ...
          if (responseJSON.errors.card_number != undefined) {
            expect(responseJSON.errors.card_number).toContain(
              card_number_error
            );
          }
          ...
          if (responseJSON.errors.card_expiration_date != undefined) {
            expect(responseJSON.errors.card_expiration_date).toContain(
  ...
  async getShippingInfo({
    ...
    let response = await this.page.request[method](
      `${customersEndpoint()}/${userID}/shipping-info`,
      {
        headers: {
          Accept: this.getAcceptHeader(),
          Authorization: this.getAuthorizationHeader(token),
  ...
  async updateShippingInfo({
    ...
    if (response.status() == 200) {
      ...
      expect(responseJSON.shipping_info.street_and_number).toBe(
        street_and_number
      );
      ...
      switch (response.status()) {
        ...
        case 422:
          ...
          if (responseJSON.errors.street_and_number != undefined) {
            expect(responseJSON.errors.street_and_number).toContain(
              street_and_number_error
            );
          }
          if (responseJSON.errors.phone_number != undefined) {
            expect(responseJSON.errors.phone_number).toContain(
              phone_number_error
            );
          }
          ...
          if (responseJSON.errors.postal_code != undefined) {
            expect(responseJSON.errors.postal_code).toContain(
              postal_code_error
            );
          }
